...
/*  Created On : 14-Dec-2022 22:53:18 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */
...
(
	...
	k_tipo_documento varchar(3) NOT NULL,	-- Tipo de documento del paciente C.C -> cedula de ciudadania T.I -> tarjeta de identidad C.E -> cedula de extranjeria R.C -> Registro Civil
	k_agenda integer NOT NULL,	-- Identificador de la agenda 
	...
	i_estado varchar(1) NOT NULL,	-- Estado de la cita : A: Asistida C: Cancelada I: Incumplida
	...
	o_especialidad varchar(20) NOT NULL	--     - Medicina general     - Pediatria     - Oftalmología     - Odontologia
)
;
...
(
	...
	k_paciente_afiliado integer NOT NULL,	-- Identificador del paciente que es Afiliado en caso de ser un Beneficiario 
	k_tipo_documento_afiliado varchar(3) NOT NULL,	-- Tipo de documento de identidad del paciente que es Afiliado en caso de ser un Beneficiario
...
ALTER TABLE Cita ADD CONSTRAINT CK_o_especialidad CHECK (o_especialidad IN ('Pediatria','Medicina General','Oftalmologia','Odontologia'))
;
